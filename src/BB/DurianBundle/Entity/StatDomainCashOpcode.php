...
/**
 * 廳的現金 opcode 統計 (僅有會員資料)
 *
 * @ORM\Entity(repositoryClass = "BB\DurianBundle\Repository\StatDomainCashOpcodeRepository")
 * @ORM\Table(
 *     name = "stat_domain_cash_opcode",
 *     indexes = {
 *         @ORM\Index(name = "idx_stat_domian_cash_opcode_at_user_id", columns = {"at", "user_id"}),
 *         @ORM\Index(name = "idx_stat_domian_cash_opcode_domain_at", columns = {"domain", "at"}),
 *         @ORM\Index(name = "idx_stat_domain_cash_opcode_opcode_at", columns = {"opcode", "at"})
 *     }
 * )
 *
 * @author Linda 2015.01.23
 */
class StatDomainCashOpcode
{
    /**
     * @var integer
     *
