 ...
 * 負數假現金
 *
 * @ORM\Entity(repositoryClass = "BB\DurianBundle\Repository\CashFakeNegativeRepository")
 * @ORM\Table(name = "cash_fake_negative", indexes = {
 *     @ORM\Index(name = "idx_cash_fake_negative_negative", columns = {"negative"})
 * })
 */
class CashFakeNegative
{
    /**
     * 使用者編號
     *
     ...
     * @return CashFakeNegative
     */
    public function setCashFakeId($cashFakeId)
    {
        $this->cashFakeId = $cashFakeId;
