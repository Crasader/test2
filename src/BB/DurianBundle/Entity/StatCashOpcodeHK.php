 ...
 * 現金 opcode 統計 (香港時區)
 *
 * @ORM\Entity(repositoryClass = "BB\DurianBundle\Repository\StatCashOpcodeHKRepository")
 * @ORM\Table(
 *     name = "stat_cash_opcode_hk",
 *     indexes = {
 *         @ORM\Index(name = "idx_stat_cash_opcode_hk_at_user_id", columns = {"at", "user_id"}),
 *         @ORM\Index(name = "idx_stat_cash_opcode_hk_domain_at", columns = {"domain", "at"}),
 *         @ORM\Index(name = "idx_stat_cash_opcode_hk_opcode_at", columns = {"opcode", "at"})
 *     }
 * )
 *
 * @author Ruby 2016.03.04
 */
class StatCashOpcodeHK
{
    /**
     * @var integer
     *
