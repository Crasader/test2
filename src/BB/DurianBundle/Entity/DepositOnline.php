...
/**
 * 線上存款
 * repositoryClass = "BB\DurianBundle\Repository\DepositOnlineRepository"
 *
 * @ORM\Entity
 * @ORM\Table(name = "deposit_online")
 */
class DepositOnline extends Deposit
{
    /**
     * 對應的付款設定
     *
     * @var PaymentCharge
     *
     * @ORM\OneToOne(targetEntity = "PaymentCharge", inversedBy = "depositOnline")
     * @ORM\JoinColumn(
    ...
    public function __construct(PaymentCharge $paymentCharge)
    {
        ...
        $paymentCharge->addDepositOnline($this);
    }
