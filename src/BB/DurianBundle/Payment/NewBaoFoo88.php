 ...
 * 新第四方寶付支付
 */
class NewBaoFoo88 extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        'p0_Cmd' => 'Buy', // 業務類型，固定值Buy
        'p1_MerId' => '', // 商號
        'p2_Order' => '', // 訂單號
        'p3_Amt' => '', // 支付金額，精確到分
        'p4_Cur' => 'CNY', // 幣別，固定值CNY
        'p5_Pid' => '', // 商品名稱，可空
        'p6_Pcat' => '', // 商品種類，可空
        'p7_Pdesc' => '', // 商品描述，可空
        'p8_Url' => '', // 支付成功返回url
    ...
    public function getVerifyData()
    {
        ...
        if ($this->options['paymentVendorId'] == 1090) {
            // 取得host部分
            $host = parse_url($this->options['postUrl'], PHP_URL_HOST);
            $postUrl = sprintf('http://%s/GateWay/ReceiveWX.aspx', $host);
