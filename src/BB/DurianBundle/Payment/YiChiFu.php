 ...
 * 憶起付
 */
class YiChiFu extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        ...
        'input_charset' => 'UTF-8', // 參數編碼字符集，固定值，網銀專用
    ...
    protected $trackingRequestData = [
        ...
        'merchant_code' => '', // 商號
        'interface_version' => 'V3.0', // 接口版本號，預設值網銀:V3.0
    ...
    private function setTrackingRequestData()
    {
        ...
        if (in_array($this->options['paymentVendorId'], ['1103', '1107', '1111'])) {
            $this->trackingRequestData['interface_version'] = 'V3.1';
        }
