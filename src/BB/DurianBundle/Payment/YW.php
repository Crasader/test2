...
class YW extends PaymentBase
{
    ...
    protected $bankMap = [
        '1090' => 'YW_Weixin_QR', // 微信_二維
        '1092' => 'YW_Alipay_QR', // 支付寶_二維
        '1097' => 'YW_Weixin_H5', // 微信_手機
    ];
    ...
    public function getVerifyData()
    {
        ...
        if (!preg_match_all($pattern, htmlspecialchars_decode($parseData['url']), $out)) {
            throw new PaymentConnectionException('Get pay parameters failed', 180128, $this->getEntryId());
        }
