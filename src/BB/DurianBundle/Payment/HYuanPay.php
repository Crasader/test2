 ...
 * 寰源支付
 */
class HYuanPay extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        'version' => '3.0', // 版本號，固定值
        'method' => 'HY.online.interface', // 接口名稱，固定值
        'partner' => '', // 商戶號
        'banktype' => '', // 銀行代碼
        'paymoney' => '', // 訂單金額，單位:元，保留到小數第二位
        'ordernumber' => '', // 商戶訂單號
        'callbackurl' => '', // 異步通知網址
        'hrefbackurl' => '', // 同步通知網址，可為空
        'attach' => '', // 備註，可為空
        'isshow' => '0', // 是否顯示收銀台，0為返回二維碼網址
        'sign' => '', // 簽名
    ];
    ...
    protected $bankMap = [
        ...
        '234' => 'BJRCB', // 北京農村商業銀行
        '278' => 'QUICKPAY', // 銀聯在線
        '1088' => 'QUICKPAYWAP', // 銀聯_手機支付
        '1103' => 'QQ', // QQ_二維
        '1104' => 'QQWAP', // QQ_手機支付
        '1111' => 'UNIONPAY', // 銀聯_二維
        '1120' => 'UNIONPAYWAP', // 銀聯錢包_手機支付
    ];
