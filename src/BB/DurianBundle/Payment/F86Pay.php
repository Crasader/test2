 ...
 * F86支付
 */
class F86Pay extends PaymentBase
{
    /**
     * 支付提交參數
     *
    ...
    protected $bankMap = [
        278 => 'UNION_PAY', // 銀聯快捷
        1088 => 'H5_UNION_PAY', // 銀聯快捷_手機支付
        1090 => 'WECHAT_QRCODE_PAY', // 微信_二維
        1092 => 'ALIPAY_QRCODE_PAY', // 支付寶_二維
        1097 => 'WECHAT_WAP_PAY', // 微信_手機支付
        1098 => 'ALIPAY_WAP_PAY', // 支付寶_手機支付
        1100 => 'ONLINE_BANK_PAY', // 手機支付_收銀台
        1102 => 'ONLINE_BANK_PAY', // PC_收銀台
        1103 => 'QQ_QRCODE_PAY', // QQ_二維
        1104 => 'QQ_WAP_PAY', // QQ_手機支付
        1107 => 'JD_QRCODE_PAY', // 京東錢包_二維
        1108 => 'JD_WAP_PAY', // 京東錢包_手機支付
        1111 => 'UNION_QRCODE_PAY', // 銀聯快捷_二維
    ];
    ...
    public function getVerifyData()
    {
        ...
        // 提交網址需要納簽，加密後unset
        $this->requestData['postUrl'] = $this->options['postUrl'];

        // 設定請求頭證書編號
        $this->requestHeader['x-oapi-sk'] = $merchantExtraValues['merchantCerNo'];

        // 設定提交對外網址
        $parseUrl = parse_url($this->requestData['postUrl']);
        $uri = $parseUrl['path'];
    ...
    protected function encode()
    {
        ...
        $encodeData[] = $this->requestData['postUrl'];
        unset($this->requestData['postUrl']);
