 ...
 * 多得寶
 */
class DuoDeBao extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $bankMap = [
        ...
        '1097' => 'wxpay_h5', // 微信_手機支付
        '1098' => 'alipay_h5', // 支付寶_手機支付
        '1103' => 'qq_scan', // QQ二維
        '1107' => 'jdpay_scan', // 京東錢包二維
        '1111' => 'ylpay_scan', // 銀聯錢包二維
    ];
    ...
    public function getVerifyData()
    {
        ...
        if (in_array($this->options['paymentVendorId'], [1090, 1092, 1103, 1107, 1111])) {
            // 調整額外參數設定
            $this->requestData['interface_version'] = 'V3.3';

            // 支付寶二維V3.3有立減功能所以將版本改為V3.1
