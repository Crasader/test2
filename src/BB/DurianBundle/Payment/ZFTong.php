 ...
 * 支付通
 */
class ZFTong extends PaymentBase
{
    /**
     * 支付提交參數
     *
    ...
    public function getVerifyData()
    {
        ...
        if ($this->options['paymentVendorId'] == 1097) {
            ...
            $this->requestData['appName'] = 'appName';
            $this->requestData['appMsg'] = 'AppPay';
            $this->requestData['appType'] = 'android';
            $this->requestData['backUrl'] = $this->requestData['returnUrl'];

            foreach ($this->h5EncodeParams as $value) {
                $this->encodeParams[] = $value;
            }
        }
        ...
        if (in_array($this->options['paymentVendorId'], [278, 1088])) {
            $this->requestData['paymethod'] = 'bankPay';
        }
