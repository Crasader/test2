 ...
 * 3. 驗證結果是否相符
 */
class Lokpay extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        ...
        'P_Subject'     => '',  //產品名稱
        'P_Price'       => '0', //產品價格
        'P_Quantity'    => '1', //產品數量，必須
        'P_Description' => '',  //產品描述
        'P_Notic'       => '',  //用戶附加訊息
        'P_Result_URL'  => '',  //充值狀態通知網址
    ...
    protected $requireMap = [
        ...
        'P_Subject' => 'username', // 產品名稱(後台顯示用，方便業主對帳)
        'P_Description' => 'domain', // 產品描述
        'P_Notic' => 'merchantId' // 用戶附加訊息
    ];
    ...
    public function verifyOrderPayment($entry)
    {
        ...
        //如果沒有P_PostKey也要丟例外(其他參數都在前面驗證過了，所以不須要驗證)
        ...
        //如果沒有P_ErrCode也要丟例外(其他參數都在前面驗證過了，所以不須要驗證)
