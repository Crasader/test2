 ...
 * 艾付支付
 */
class IFeePay extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        ...
        'bank_code' => '', // 銀行編碼
        'card_type' => '0', // 允許支付的卡類型，0:借記卡 1:信用卡 2:都行
        'sign' => '', // 簽名
    ];
    ...
    public function withdrawPayment()
    {
        ...
        $this->withdrawRequestData['bank_name'] = $this->withdrawBankNameMap[$this->options['bank_info_id']];
