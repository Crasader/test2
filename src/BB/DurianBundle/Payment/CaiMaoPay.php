 ...
 * 財貓支付
 */
class CaiMaoPay extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $bankMap = [
        ...
        '1097' => 'weixin_h5api', // 微信手機支付
        '1103' => 'tenpay_scan', // QQ二維
        '1107' => 'jdpay_scan', // 京東二維
        '1111' => 'ylpay_scan', // 銀聯二維
    ];
    ...
    public function getVerifyData()
    {
        ...
        // 二維支付、手機支付
        if (in_array($this->options['paymentVendorId'], [1090, 1092, 1097, 1103, 1107, 1111])) {
            // 調整額外參數設定
    ...
    private function getPhonePayData($parseData)
    {
        ...
        $parseUrl = parse_url(urldecode($parseData['payURL']));
