 ...
 * 3. 驗證結果是否相符
 */
class NewIPS extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    public function getVerifyData()
    {
        ...
        /**
         * 如果有銀行代碼才可以用直接連到銀行的頁面，沒有的話就保持空值
         * 因為有些支付方式是不支援直連的，這邊只能讓user自己選擇
         */
    ...
    public function paymentTracking()
    {
        ...
        // 0000為成功，防止有其他的錯誤碼，因此設定非0000即為失敗
    ...
    public function getPaymentTrackingData()
    {
        ...
        $curlParam = [
            ...
            'path' => '/Sinopay/Standard/IpsCheckTrade.asmx/GetOrderByNo',
            'method' => 'POST',
