 ...
 * 極付
 */
class JeanPay extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        ...
        'return_url' => '', // 同步通知網址
        'notify_url' => '', // 異步通知網址
        'pay_type' => 'BANK_PAY', // 支付類型，BANK_PAY:網銀、QUICK_PAY:快捷
        'bank_code' => '', // 銀行代碼
    ];
    ...
    protected $bankMap = [
        ...
        '223' => 'BANK_BEA', // 東亞银行
        '226' => 'BANK_BON', // 南京银行
        '228' => 'BANK_SRCB', // 上海農村商業银行
        '234' => 'BANK_BJRCB', // 北京農村商業银行
        '278' => 'QPAY_UNIONPAY', // 銀聯在線
        '321' => 'BANK_TCCB', // 天津銀行
        '361' => 'BANK_ZJTLCB', // 泰隆銀行
        '1088' => 'QPAY_UNIONPAY', // 銀聯在線手機支付
        '1090' => 'WXPAY_QRCODE', // 微信二維
        '1092' => 'ALIPAY_QRCODE', // 支付寶二維
        '1103' => 'QQPAY_QRCODE', // QQ二維
    ];
    ...
    public function paymentTrackingVerify()
    {
        ...
        if (!isset($response['respCode']) || !isset($response['respMessage']) || !isset($response['respResult'])) {
