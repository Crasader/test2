 ...
 * Bingopay
 */
class BingoPay extends PaymentBase
{
    /**
     * 支付提交參數
     *
    ...
    public function getVerifyData()
    {
        ...
        // 非網銀調整業務交互數據參數
        if (in_array($this->options['paymentVendorId'], [1108, 1111])) {
            $this->requestData['productId'] = '0100';
            $this->businessData['bus_no'] = $this->busNoMap[$this->options['paymentVendorId']];
