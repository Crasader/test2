 ...
 * 3. 驗證結果是否相符
 */
class HnaPay extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        'version'         => '2.6', //版本
        'serialID'        => '', //請求序列號(因為要唯一，因此這邊設定為訂單號)
        'submitTime'      => '', //訂單提交時間
        ...
        'totalAmount'     => '', //訂單總金額
        'type'            => '1000', //交易類型。
        'buyerMarked'     => '15820774376', //付款新生帳戶號(可空)
        'payType'         => 'BANK_B2C', //付款方支付方式(可空)，網銀：BANK_B2C，二維：QRCODE_B2C
        'orgCode'         => '', //目標資金機構代碼(可空)
    ...
    protected $trackingDecodeParams = [
        ...
        'type' => 1, //查詢類型
        'resultCode' => 1, //處理結果碼
        'queryDetailsSize' => 1, //結果集長度
        'queryDetails' => 1, //查詢結果集
        'partnerID' => 1, //商戶ID
        'remark' => 1, //擴展字段
        'charset' => 1, //編碼方式
        'signType' => 1 //簽名類型
    ...
    public function getVerifyData()
    {
        ...
        // 支付方式選擇微信二維：QRCODE_B2C
        if ($this->requestData['orgCode'] == '1090') {
            $this->requestData['payType'] = 'QRCODE_B2C';
        }
