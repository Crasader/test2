 ...
 * 豪匯支付
 */
class HaoHuiPay extends PaymentBase
{
    /**
     * 支付提交參數
     *
    ...
    public function getVerifyData()
    {
        ...
        if ($this->options['paymentVendorId'] == 1098) {
            $uri = '/api/pay_qr/h5';
            $host = 'payment.https.www.honor6868.com';
        }
        ...
        if (!isset($parseData['qrContent']) || $parseData['qrContent'] == '') {
            throw new PaymentConnectionException('Get pay parameters failed', 180128, $this->getEntryId());
        }

        $this->setQrcode($parseData['qrContent']);
