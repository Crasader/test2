 ...
 * 智得寶
 */
class ZhiDeBao extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    public function getVerifyData()
    {
        ...
        // 二維支付 && 手機支付
        if (in_array($this->options['paymentVendorId'], [1090, 1092, 1097, 1103])) {
            // 調整額外參數設定
        ...
        // 調整網銀提交網址，input_charset值為參數編碼
        $postUrl = 'https://pay.' . $this->options['postUrl'] .
            '/gateway?input_charset=' . $this->requestData['input_charset'];
