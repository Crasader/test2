 ...
 * 3. 驗證結果是否相符
 */
class YeePay extends PaymentBase
{
    /**
     * 支付時要傳給平台驗證的參數
     *
    ...
    protected $requestData = [
        ...
        'p6_Pcat'         => '0', //商品種類(後台顯示，不讓明細看起來都是空白)
        'p7_Pdesc'        => '0', //商品描述(後台顯示，不讓明細看起來都是空白)
        'p8_Url'          => '', //支付成功返回url
        'p9_SAF'          => '0', //送貨地址 0: 不需要保留在易寶
        'pa_MP'           => '', //商戶擴展訊息
        'pd_FrpId'        => '', //銀行代碼
    ...
    public function paymentTracking()
    {
        ...
        $curlParam = [
            'method' => 'POST',
            'uri' => '/app-merchant-proxy/command',
        ...
        if ($parseData['rb_PayStatus'] == 'AUTHORIZED') {
    ...
    public function getPaymentTrackingData()
    {
        ...
        $curlParam = [
            ...
            'path' => '/app-merchant-proxy/command',
            'method' => 'POST',
