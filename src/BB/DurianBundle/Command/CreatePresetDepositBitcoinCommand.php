 ...
 * DepositBitcoin預設值設定
 */
class CreatePresetDepositBitcoinCommand extends ContainerAwareCommand
{
    /**
    ...
    {
        $this
            ->setName('durian:create-preset-depositbitcoin')
            ->setDescription('DepositBitcoin預設值設定');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->log("總共新增 $paymentChargeCount 筆 DepositBitcoin.");
    ...
    private function setUpLogger()
    {
        ...
        $logPath = $logsDir . DIRECTORY_SEPARATOR . 'create_preset_depositbitcoin.log';
