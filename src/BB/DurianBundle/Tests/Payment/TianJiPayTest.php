...
use BB\DurianBundle\Payment\TianJiPay;
use Buzz\Message\Response;

class TianJiPayTest extends DurianTestCase
{
    /**
    ...
    public function testPayWithoutPrivateKey()
    {
        ...
        $tianJiPay = new TianJiPay();
        $tianJiPay->getVerifyData();
    }
    ...
    public function testPayWithNoPayParameterSpecified()
    {
        ...
        $tianJiPay = new TianJiPay();
        $tianJiPay->setPrivateKey('test');
        $tianJiPay->setOptions($sourceData);
        $tianJiPay->getVerifyData();
    }
    ...
    public function testPayUnsupportedPaymentVendor()
    {
        ...
        $sourceData = [
            ...
            'verify_url' => 'payment.http.gate.iceuptrade.com',
    ...
    public function testPayReturnWithoutCode()
    {
        ...
        $tianJiPay = new TianJiPay();
        $tianJiPay->setPrivateKey('test');
        $tianJiPay->setContainer($this->container);
        $tianJiPay->setClient($this->client);
        $tianJiPay->setResponse($response);
        $tianJiPay->setOptions($sourceData);
        $tianJiPay->getVerifyData();
    }
    ...
    public function testQrcodePay()
    {
        ...
        $tianJiPay->setResponse($response);
        $tianJiPay->setOptions($sourceData);
        $verifyData = $tianJiPay->getVerifyData();

        $this->assertEmpty($verifyData);
        $this->assertSame('weixin://wxpay/bizpayurl?pr=JwCYf9f', $tianJiPay->getQrcode());
    }
    ...
    public function testReturnOrderIdFailed()
    {
        ...
        $tianJiPay->setPrivateKey('test');
        $tianJiPay->setOptions($sourceData);
        $tianJiPay->verifyOrderPayment($entry);
    }
    ...
    public function testPaySuccess()
    {
        ...
        $this->assertEquals('SUCCESS', $tianJiPay->getMsg());
    }
}