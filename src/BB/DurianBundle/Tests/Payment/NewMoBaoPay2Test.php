...
use BB\DurianBundle\Payment\NewMoBaoPay2;
use Buzz\Message\Response;

class NewMoBaoPay2Test extends DurianTestCase
{
    /**
    ...
    public function testPayWithoutPrivateKey()
    {
        ...
        $newMoBaoPay2 = new NewMoBaoPay2();
        $newMoBaoPay2->getVerifyData();
    }
    ...
    public function testPayWithNoPayParameterSpecified()
    {
        ...
        $newMoBaoPay2 = new NewMoBaoPay2();
        $newMoBaoPay2->setPrivateKey('test');
        $newMoBaoPay2->getVerifyData();
    }
    ...
    public function testPaySourceNotSupportBank()
    {
        ...
        $newMoBaoPay2 = new NewMoBaoPay2();
        $newMoBaoPay2->setPrivateKey('test');
        $newMoBaoPay2->setOptions($options);
        $newMoBaoPay2->getVerifyData();
    }
    ...
    public function testPay()
    {
        ...
        $newMoBaoPay2->setPrivateKey('test');
        $newMoBaoPay2->setOptions($options);
        $requestData = $newMoBaoPay2->getVerifyData();
    ...
    public function testReturnWithoutPrivateKey()
    {
        ...
        $newMoBaoPay2 = new NewMoBaoPay2();
        $newMoBaoPay2->verifyOrderPayment([]);
    }
    ...
    public function testReturnOrderIdError()
    {
        ...
        $newMoBaoPay2->setPrivateKey('test');
        $newMoBaoPay2->setOptions($options);
        $newMoBaoPay2->verifyOrderPayment($entry);
    }
    ...
    public function testReturnOrder()
    {
        ...
        $this->assertEquals('SUCCESS', $newMoBaoPay2->getMsg());
    }
    ...
    public function testTrackingReturnWithoutRespData()
    {
        ...
        $newMoBaoPay2 = new NewMoBaoPay2();
        $newMoBaoPay2->setContainer($this->container);
        $newMoBaoPay2->setClient($this->client);
        $newMoBaoPay2->setResponse($response);
        $newMoBaoPay2->setPrivateKey('test');
        $newMoBaoPay2->setOptions($options);
        $newMoBaoPay2->paymentTracking();
    }
