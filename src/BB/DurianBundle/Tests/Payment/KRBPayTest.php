...
use BB\DurianBundle\Payment\KRBPay;

class KRBPayTest extends DurianTestCase
{
    /**
     * 測試支付時缺少私鑰
     */
    ...
    public function testPay()
    {
        ...
        $kRBPay->setPrivateKey('test');
        $kRBPay->setOptions($options);
        $requestData = $kRBPay->getVerifyData();
    ...
    public function testReturnOrderIdError()
    {
        ...
        $kRBPay->setPrivateKey('test');
        $kRBPay->setOptions($options);
        $kRBPay->verifyOrderPayment($entry);
    }
    ...
    public function testReturnOrder()
    {
        ...
        $this->assertEquals('success', $kRBPay->getMsg());
    }
}
