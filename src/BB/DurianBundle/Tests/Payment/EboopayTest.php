...
use BB\DurianBundle\Payment\Eboopay;

class EboopayTest extends DurianTestCase
{
    /**
     * 測試支付時缺少私鑰
     */
    ...
    public function testPay()
    {
        ...
        $this->assertEquals($options['orderId'] . $options['number'], $encodeData['pay_orderid']);
        ...
        $this->assertEquals('4B4567669F0492C7951CFD604FE0C175', $encodeData['pay_md5sign']);
    }
