...
use BB\DurianBundle\Payment\XinLuPay;
use Buzz\Message\Response;

class XinLuPayTest extends DurianTestCase
{
    /**
    ...
    public function testPayWithoutPrivateKey()
    {
        ...
        $xinLuPay = new XinLuPay();
        $xinLuPay->getVerifyData();
    }
    ...
    public function testPayWithNoPayParameterSpecified()
    {
        ...
        $xinLuPay = new XinLuPay();
        $xinLuPay->setPrivateKey('test');
        $xinLuPay->setOptions($sourceData);
        $xinLuPay->getVerifyData();
    }
    ...
    public function testPayNoReturnRetCode()
    {
        ...
        $xinLuPay = new XinLuPay();
        $xinLuPay->setContainer($this->container);
        $xinLuPay->setClient($this->client);
        $xinLuPay->setResponse($response);
        $xinLuPay->setPrivateKey('test');
        $xinLuPay->setOptions($sourceData);
        $xinLuPay->getVerifyData();
    }
    ...
    public function testQrcodePay()
    {
        ...
        $xinLuPay->setPrivateKey('test');
        $xinLuPay->setOptions($sourceData);
        $data = $xinLuPay->getVerifyData();

        $this->assertEmpty($data);
        $this->assertEquals('https://myun.tenpay.com/mqq/pay/qrcode.html?_wv=1027&_bid=21', $xinLuPay->getQrcode());
    }
    ...
    public function testReturnOrderIdError()
    {
        ...
        $xinLuPay->setPrivateKey('test');
        $xinLuPay->setOptions($sourceData);
        $xinLuPay->verifyOrderPayment($entry);
    }
    ...
    public function testReturnSuccess()
    {
        ...
        $this->assertEquals('success', $xinLuPay->getMsg());
    }
}
