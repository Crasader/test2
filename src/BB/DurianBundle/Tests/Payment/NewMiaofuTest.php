...
use BB\DurianBundle\Payment\NewMiaofu;
use Buzz\Message\Response;

class NewMiaofuTest extends DurianTestCase
{
    /**
    ...
    public function testPayWithoutPrivateKey()
    {
        ...
        $newMiaofu = new NewMiaofu();
        $newMiaofu->getVerifyData();
    }
    ...
    public function testPayReturnNotSupportedVendor()
    {
        ...
        $newMiaofu = new NewMiaofu();
        $newMiaofu->setContainer($this->container);
        $newMiaofu->setClient($this->client);
        $newMiaofu->setResponse($response);
        $newMiaofu->setPrivateKey('test');
        $newMiaofu->setOptions($options);
        $newMiaofu->getVerifyData();
    }
    ...
    public function testPayQrcode()
    {
        ...
        $newMiaofu->setPrivateKey('test');
        $newMiaofu->setOptions($options);
        $requestData = $newMiaofu->getVerifyData();

        $this->assertEquals($url, $newMiaofu->getQrcode());
    ...
    public function testReturnOrderIdError()
    {
        ...
        $newMiaofu->setPrivateKey('test');
        $newMiaofu->setOptions($options);
        $newMiaofu->verifyOrderPayment($entry);
    }
    ...
    public function testReturnOrder()
    {
        ...
        $this->assertEquals('success', $newMiaofu->getMsg());
    }
    ...
    public function testGetPaymentTrackingDataWithoutPrivateKey()
    {
        ...
        $newMiaofu = new NewMiaofu();
        $newMiaofu->getPaymentTrackingData();
    }
    ...
    public function testGetPaymentTrackingData()
    {
        ...
        $newMiaofu->setPrivateKey('test');
        $newMiaofu->setOptions($options);
        $trackingData = $newMiaofu->getPaymentTrackingData();
