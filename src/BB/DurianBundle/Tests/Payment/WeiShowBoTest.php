...
use BB\DurianBundle\Payment\WeiShowBo;

class WeiShowBoTest extends DurianTestCase
{
    /**
     * 提交給支付平台時需要的參數
     *
    ...
    public function testPayWithoutKey()
    {
        ...
        $weiShowBo = new WeiShowBo();
        $weiShowBo->getVerifyData();
    }
    ...
    public function testPayWithNoPayParameterSpecified()
    {
        ...
        $weiShowBo = new WeiShowBo();
        $weiShowBo->setPrivateKey('test');
        $weiShowBo->setOptions([]);
        $weiShowBo->getVerifyData();
    }
    ...
    public function testPayWithUnsupportedPaymentVendor()
    {
        ...
        $weiShowBo = new WeiShowBo();
        $weiShowBo->setPrivateKey('test');
        $weiShowBo->setOptions($this->option);
        $weiShowBo->getVerifyData();
    }
    ...
    public function testPay()
    {
        ...
        $weiShowBo->setPrivateKey('test');
        $weiShowBo->setOptions($this->option);
        $encodeData = $weiShowBo->getVerifyData();
        ...
        $this->assertEquals('GET', $weiShowBo->getPayMethod());
    }
    ...
    public function testReturnWithoutSignature()
    {
        ...
        $weiShowBo = new WeiShowBo();
        $weiShowBo->setPrivateKey('test');
        $weiShowBo->setOptions($this->returnResult);
        $weiShowBo->verifyOrderPayment([]);
    }
    ...
    public function testReturnPaymentOrderIdError()
    {
        ...
        $weiShowBo->setPrivateKey('test');
        $weiShowBo->setOptions($this->returnResult);
        $weiShowBo->verifyOrderPayment($entry);
    }
    ...
    public function testReturnResultSuccess()
    {
        ...
        $this->assertEquals('success', $weiShowBo->getMsg());
    }
}
