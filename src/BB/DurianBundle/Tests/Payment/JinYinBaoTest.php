...
use BB\DurianBundle\Payment\JinYinBao;

class JinYinBaoTest extends DurianTestCase
{
    /**
     * 測試支付時缺少私鑰
     */
    public function testPayWithoutPrivateKey()
    {
        ...
        $jinYinBao = new JinYinBao();
        $jinYinBao->getVerifyData();
    }
    ...
    public function testPay()
    {
        ...
        $jinYinBao->setPrivateKey('test');
        $jinYinBao->setOptions($options);
        $encodeData = $jinYinBao->getVerifyData();
    ...
    public function testReturnOrderIdError()
    {
        ...
        $jinYinBao->setPrivateKey('test');
        $jinYinBao->setOptions($options);
        $jinYinBao->verifyOrderPayment($entry);
    }
    ...
    public function testReturnSuccess()
    {
        ...
        $this->assertEquals('success', $jinYinBao->getMsg());
    }
}
