...
use BB\DurianBundle\Payment\KeXunPay;
use Buzz\Message\Response;

class KeXunPayTest extends DurianTestCase
{
    /**
    ...
    public function testPayWithoutPrivateKey()
    {
        ...
        $keXunPay = new KeXunPay();
        $keXunPay->getVerifyData();
    }
    ...
    public function testPayWithNoPayParameterSpecified()
    {
        ...
        $keXunPay = new KeXunPay();
        $keXunPay->setPrivateKey('test');
        $keXunPay->setOptions($sourceData);
        $keXunPay->getVerifyData();
    }
    ...
    public function testPay()
    {
        ...
        $keXunPay->setPrivateKey('test');
        $keXunPay->setOptions($sourceData);
        $encodeData = $keXunPay->getVerifyData();
        ...
        $this->assertEquals('7c3cd43b4837e94f9b4b83880df4b35b', $encodeData['sign']);
    }
    ...
    public function testReturnWithoutSign()
    {
        ...
        $sourceData = [
            ...
            'opstate' => '0',
            'ovalue' => '2',
            'sysorderid' => 'B2220201702091339453704949',
    ...
    public function testReturnOrderIdFailed()
    {
        ...
        $keXunPay->setPrivateKey('test');
        $keXunPay->setOptions($sourceData);
        $keXunPay->verifyOrderPayment($entry);
    }
    ...
    public function testPaySuccess()
    {
        ...
        $this->assertEquals('opstate=0', $keXunPay->getMsg());
    }
    ...
    public function testTrackingReturnWithoutParameter()
    {
        ...
        $sourceData = [
            ...
            'orderId' => '201702100000001344',
            'verify_ip' => ['172.26.54.42', '172.26.54.41'],
            'verify_url' => 'payment.http.pay.kexunpay.com',
        ];

        $keXunPay = new KeXunPay();
        $keXunPay->setContainer($this->container);
        $keXunPay->setClient($this->client);
        $keXunPay->setResponse($response);
        $keXunPay->setPrivateKey('test');
        $keXunPay->setOptions($sourceData);
        $keXunPay->paymentTracking();
    }
    ...
    public function testGetPaymentTrackingDataWithoutPrivateKey()
    {
        ...
        $keXunPay = new KeXunPay();
        $keXunPay->getPaymentTrackingData();
    }
    ...
    public function testGetPaymentTrackingData()
    {
        ...
        $keXunPay->setPrivateKey('test');
        $keXunPay->setOptions($sourceData);
        $trackingData = $keXunPay->getPaymentTrackingData();

        $this->assertEquals($sourceData['verify_ip'], $trackingData['verify_ip']);
        $this->assertEquals('POST', $trackingData['method']);
        $this->assertEquals('/search.aspx', $trackingData['path']);
    ...
    public function testPaymentTrackingVerifyWithoutPrivateKey()
    {
        ...
        $keXunPay = new KeXunPay();
        $keXunPay->paymentTrackingVerify();
    }
