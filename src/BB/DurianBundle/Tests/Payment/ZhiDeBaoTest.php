...
use BB\DurianBundle\Payment\ZhiDeBao;
use BB\DurianBundle\Tests\DurianTestCase;
use Buzz\Message\Response;

class ZhiDeBaoTest extends DurianTestCase
{
    /**
     * 私鑰
     *
    ...
    public function testSetEncodeSourceNoNumber()
    {
        ...
        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->setOptions($sourceData);
        $zhiDeBao->getVerifyData();
    }
    ...
    public function testSetEncodeSourceUnsupportedPaymentVendor()
    {
        ...
        $sourceData = [
            ...
            'orderId' => '2017102609527',
            'orderCreateDate' => '2017-10-26 16:40:11',
            'amount' => '0.01',
            'username' => 'php1test',
    ...
    public function testGetEncodeNoReturnRespCode()
    {
        ...
        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->setContainer($this->container);
        $zhiDeBao->setClient($this->client);
        $zhiDeBao->setResponse($response);
        $zhiDeBao->setOptions($sourceData);
        $zhiDeBao->getVerifyData();
    }
    ...
    public function testGetEncodeReturnRespCodeNotSuccess()
    {
        ...
        $sourceData = [
            'number' => '9527',
            'notify_url' => 'http://59.126.84.197:3030/return.php',
            'orderId' => '2017102609527444444444',
            'orderCreateDate' => '2017-10-26 16:40:11',
            'amount' => '0.01',
            'username' => 'php1test',
            'paymentVendorId' => '1092',
     ...
     * 測試手機支付未返回payURL
     */
    public function testPayWithHFiveNoReturnPayUrl()
    {
        $this->setExpectedException(
            'BB\DurianBundle\Exception\PaymentConnectionException',
            'Get pay parameters failed',
     ...
     * 測試手機支付返回payURL格式錯誤
     */
    public function testPayWithHFiveReturnPayUrlFormatError()
    {
        $this->setExpectedException(
            'BB\DurianBundle\Exception\PaymentConnectionException',
            'Get pay parameters failed',
    ...
    public function testPayWithOnlineBank()
    {
        $encodeStr = 'bank_code=ICBC&client_ip=127.0.0.1&input_charset=UTF-8&interface_version=V3.0' .
            ...
            '&order_no=2017102609527&order_time=2017-10-26 16:48:41&product_name=php1test&service_type=direct_pay';

        $sourceData = [
            'number' => '6000016833',
            'notify_url' => 'http://59.126.84.197/return.php',
            'orderId' => '2017102609527',
            'orderCreateDate' => '2017-10-26 16:48:41',
            'amount' => '0.01',
            'username' => 'php1test',
            'paymentVendorId' => '1',
            'rsa_private_key' => $this->privateKey,
        ...
        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->setOptions($sourceData);
        $requestData = $zhiDeBao->getVerifyData();
        ...
        $this->assertEquals('2017102609527', $requestData['params']['order_no']);
        $this->assertEquals('2017-10-26 16:48:41', $requestData['params']['order_time']);
    ...
    public function testPayWithHFive()
    {
        $result = '<?xml version="1.0" encoding="UTF-8" ?>' .
            ...
            '<result_desc>通讯成功</result_desc>' .
            '<sign_type>RSA-S</sign_type>' .
            '<payURL>https://api.ulopay.com/pay/location?url=aHR0cDovL20ueWlnb25neW91bGUuY29tL2F</payURL>' .
            '<sign>ZWENv7QbH6sIC4DhJ50wbG2ovyiuRGPAoPrnp ke9mGC2IDVVU/d HUmpFwWcWxwQLB sy1GgpvUL5fGsTrbSkxXsijQz6q0' .
            'Q81vTlKt0cBvw7PSeuhxHpxy1zeO jaNqTDesY6HPGCK6TPXv/roY3XKpG4 YOCzfGp XtbPzc=</sign>' .
            '</response></dinpay>';
        ...
        $this->assertEquals('https://api.ulopay.com/pay/location', $requestData['post_url']);
        $this->assertEquals('aHR0cDovL20ueWlnb25neW91bGUuY29tL2F', $requestData['params']['url']);
    }
    ...
    public function testGetEncodeData()
    {
        ...
        $sourceData = [
            ...
            'rsa_private_key' => $this->privateKey,
            'verify_ip' => ['172.26.54.42', '172.26.54.41'],
            'postUrl' => 'payment.https.api.zdbbill.com',
            'ip' => '127.0.0.1',
        ];
        ...
        $zhiDeBao->setResponse($response);
        $zhiDeBao->setOptions($sourceData);
        $encodeData = $zhiDeBao->getVerifyData();

        $this->assertEmpty($encodeData);
        $this->assertEquals('weixin://wxpay/bizpayurl?pr=MtTpobS', $zhiDeBao->getQrcode());
    }
    ...
    public function testVerifyWithoutTradeStatus()
    {
        ...
        $sourceData = [
            ...
            'trade_time' => '2017-10-26 08:59:13',
        ];

        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->setOptions($sourceData);
        $zhiDeBao->verifyOrderPayment([]);
    }
    ...
    public function testVerifyWithoutSign()
    {
        ...
        $sourceData = [
            ...
            'notify_type' => 'offline_notify',
            'merchant_code' => '9527',
            'order_no' => '2017102600001',
            'trade_status' => 'SUCCESS',
            'order_amount' => '0.01',
            'interface_version' => 'V3.0',
            'bank_seq_no' => 'HFG000005221224275',
            'order_time' => '2017-10-26 08:59:00',
            'notify_id' => '6449d835356847458ab8c21f3381be10',
            'trade_time' => '2017-10-26 08:59:13',
        ];
    ...
    public function testReturnSignatureVerificationFailed()
    {
        ...
        $sourceData = [
            ...
            'order_time' => '2017-10-26 08:59:00',
            'notify_id' => '6449d835356847458ab8c21f3381be10',
            'trade_time' => '2017-10-26 09:31:31',
    ...
    public function testReturnGetRsaPublicKeyEmpty()
    {
        ...
        $sourceData = [
            ...
            'order_time' => '2017-10-26 15:09:53',
            'notify_id' => 'aa1f5f6df8d24fafaa6c14faee93cd11',
            'trade_time' => '2017-10-26 15:10:02',
            'sign' => 'test',
            'rsa_public_key' => '',
        ];
    ...
    public function testReturnPaymentFailure()
    {
        ...
        $encodeStr = 'bank_seq_no=7551102936201603310273064491&interface_version=V3.0&merchant_code=1111110166&' .
            ...
            'order_no=201710260000004830&order_time=2017-10-26+16%3A35%3A06&trade_no=1125060594&trade_status=UNPAY&' .
        ...
        $sourceData = [
            ...
            'order_no' => '201710260000004830',
            'trade_status' => 'UNPAY',
            'sign' => base64_encode($sign),
            'order_amount' => '0.01',
            'interface_version' => 'V3.0',
            'bank_seq_no' => '7551102936201603310273064491',
            'order_time' => '2017-10-26 16:35:06',
    ...
    public function testOrderIdError()
    {
        ...
        $encodeStr = 'bank_seq_no=7551102936201603310273064491&interface_version=V3.0&merchant_code=1111110166&' .
            'notify_id=5b9b67ecf6be4346ab738dddf9127c62&notify_type=offline_notify&order_amount=0.01&' .
            'order_no=201710260000004830&order_time=2017-10-26+16%3A35%3A06&trade_no=1125060594&trade_status=SUCCESS&' .
            'trade_time=2017-05-31+16%3A14%3A02';
        ...
        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->setOptions($sourceData);
        $zhiDeBao->verifyOrderPayment($entry);
    }
    ...
    public function testPaySuccess()
    {
        $encodeStr = 'bank_seq_no=7551102936201603310273064491&interface_version=V3.0&merchant_code=1111110166&' .
            'notify_id=5b9b67ecf6be4346ab738dddf9127c62&notify_type=offline_notify&order_amount=0.01&' .
            'order_no=201710260000004830&order_time=2017-10-26+16%3A35%3A06&trade_no=1125060594&trade_status=SUCCESS&' .
            'trade_time=2017-10-26+16%3A36%3A02';
        ...
        $sourceData = [
            ...
            'order_time' => '2017-10-26 16:35:06',
            'notify_id' => '5b9b67ecf6be4346ab738dddf9127c62',
            'trade_time' => '2017-10-26 16:36:02',
            'rsa_public_key' => $this->publicKey,
        ];
        ...
        $this->assertEquals('SUCCESS', $zhiDeBao->getMsg());
    }
    ...
    public function testTrackingReturnWithNoTrackingReturnParameterSpecified()
    {
        ...
        $result = '<?xml version="1.0" encoding="UTF-8" ?>' .
            ...
            '<order_no>201710260000002030</order_no>' .
            '<order_time>2017-10-26 08:38:54</order_time>' .
            '<trade_time>2017-10-26 08:38:07</trade_time>' .
    ...
    public function testTrackingReturnUnpaidOrder()
    {
        ...
        $encodeStr = 'merchant_code=9527&order_amount=0.01&order_no=2017102600001' .
            '&order_time=2017-10-26 15:09:53&trade_no=1136435210&trade_status=UNPAY&trade_time=2017-10-26 15:10:02';
        ...
        $result = '<?xml version="1.0" encoding="UTF-8" ?>' .
            ...
            '<order_amount>0.01</order_amount>' .
            '<order_no>2017102600001</order_no>' .
            '<order_time>2017-10-26 15:09:53</order_time>' .
            '<trade_no>1136435210</trade_no>' .
            '<trade_status>UNPAY</trade_status>' .
            '<trade_time>2017-10-26 15:10:02</trade_time>' .
            '</trade>' .
            '</response></dinpay>';
    ...
    public function testTrackingReturnPaymentFailure()
    {
        ...
        $encodeStr = 'merchant_code=9527&order_amount=0.01&order_no=2017102600001' .
            '&order_time=2017-10-26 15:09:53&trade_no=1136435210&trade_status=FAILED&trade_time=2017-10-26 15:10:02';
    ...
    {
        $encodeStr = 'merchant_code=9527&order_amount=0.01&order_no=2017102600001' .
            '&order_time=2017-10-26 08:59:00&trade_no=1003450919&trade_status=SUCCESS&trade_time=2017-10-26 09:31:31';
        ...
        $result = '<?xml version="1.0" encoding="UTF-8" ?>' .
            ...
            '<order_amount>0.01</order_amount>' .
            '<order_no>2017102600001</order_no>' .
            '<order_time>2017-10-26 08:59:00</order_time>' .
            '<trade_no>1003450919</trade_no>' .
            '<trade_status>SUCCESS</trade_status>' .
            '<trade_time>2017-10-26 09:31:31</trade_time>' .
            '</trade>' .
            '</response></dinpay>';
    ...
    public function testGetPaymentTrackingDataWithNoTrackingParameterSpecified()
    {
        ...
        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->getPaymentTrackingData();
    }
    ...
    public function testGetPaymentTrackingData()
    {
        ...
        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->setOptions($sourceData);
        $trackingData = $zhiDeBao->getPaymentTrackingData();
    ...
    public function testPaymentTrackingVerifyWithoutParameter()
    {
        ...
        $zhiDeBao = new ZhiDeBao();
        $zhiDeBao->setOptions($sourceData);
        $zhiDeBao->paymentTrackingVerify();
    }
    ...
    public function testPaymentTrackingVerifyWithOrderIdError()
    {
        ...
        $encodeStr = 'merchant_code=9527&order_amount=0.01&order_no=2017102600001' .
            '&order_time=2017-10-26 15:09:53&trade_no=1136435210&trade_status=SUCCESS&trade_time=2017-10-26 15:10:02';
