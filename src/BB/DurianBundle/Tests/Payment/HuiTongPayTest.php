...
use BB\DurianBundle\Payment\HuiTongPay;
use Buzz\Message\Response;

class HuiTongPayTest extends DurianTestCase
{
    /**
    ...
    public function testPayWithoutPrivateKey()
    {
        ...
        $huiTongPay = new HuiTongPay();
        $huiTongPay->getVerifyData();
    }
    ...
    public function testPayWithNoPayParameterSpecified()
    {
        ...
        $huiTongPay = new HuiTongPay();
        $huiTongPay->setPrivateKey('test');
        $huiTongPay->setOptions($sourceData);
        $huiTongPay->getVerifyData();
    }
    ...
    public function testPayNoReturnRetCode()
    {
        ...
        $huiTongPay = new HuiTongPay();
        $huiTongPay->setContainer($this->container);
        $huiTongPay->setClient($this->client);
        $huiTongPay->setResponse($response);
        $huiTongPay->setPrivateKey('test');
        $huiTongPay->setOptions($sourceData);
        $huiTongPay->getVerifyData();
    }
    ...
    public function testQrcodePay()
    {
        $result = [
            'orderNo' => '201806040000013560',
            'sign' => 'b7f89066ab18dad12846fb991b6c5409',
            'payUrl' => 'https://myun.tenpay.com/mqq/pay/qrcode.html?_wv=1027&_bid=218',
            'transNo' => '15281007905563353757683',
            'retCode' => '0',
            'userId' => 'mt1524818980855',
            'retMsg' => 'success',
        ...
        $huiTongPay->setPrivateKey('test');
        $huiTongPay->setOptions($sourceData);
        $data = $huiTongPay->getVerifyData();

        $this->assertEmpty($data);
        $this->assertEquals('https://myun.tenpay.com/mqq/pay/qrcode.html?_wv=1027&_bid=218', $huiTongPay->getQrcode());
    }
    ...
    public function testReturnOrderIdError()
    {
        ...
        $huiTongPay->setPrivateKey('test');
        $huiTongPay->setOptions($sourceData);
        $huiTongPay->verifyOrderPayment($entry);
    }
    ...
    public function testReturnSuccess()
    {
        ...
        $this->assertEquals('success', $huiTongPay->getMsg());
    }
}
