...
use BB\DurianBundle\Remit\BB;

class BBTest extends DurianTestCase
{
    /**
     * Container 的 mock
     *
    ...
    public function testCheckAutoRemitAccountButNoAutoRemitAccountFound()
    {
        ...
        $bb = new BB();
        $bb->setContainer($this->container);
        $bb->checkAutoRemitAccount();
    }
    ...
    public function testCheckAutoRemitAccountButBankInfoIsNotSupportidByAutoRemitBankInfo()
    {
        ...
        $bb = new BB();
        $bb->setContainer($this->container);
        $bb->setRemitAccount($this->remitAccount);
        $bb->checkAutoRemitAccount();
    }
