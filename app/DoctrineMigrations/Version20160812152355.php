 ...
 */
class Version20160812152355 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO `background_process` (`name`, `enable`, `begin_at`, `end_at`, `last_end_time`, `memo`, `num`, `msg_num`) VALUES ('update-user-size', 0, '2016-01-01 00:00:00', '2016-01-01 00:00:00', NULL, '更新使用者層數量', 0, 0)");
    }
}
