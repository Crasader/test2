 ...
 */
class StatDomainCashOpcode extends \BB\DurianBundle\Entity\StatDomainCashOpcode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'userId', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'currency', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'opcode', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'amount', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcode' . "\0" . 'count');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatDomainCashOpcode $proxy) {
