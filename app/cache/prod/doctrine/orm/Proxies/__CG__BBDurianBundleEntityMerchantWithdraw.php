 ...
 */
class MerchantWithdraw extends \BB\DurianBundle\Entity\MerchantWithdraw implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantWithdraw' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantWithdraw' . "\0" . 'ipStrategy', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantWithdraw' . "\0" . 'mobile');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MerchantWithdraw $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addIpStrategy(\BB\DurianBundle\Entity\MerchantWithdrawIpStrategy $strategy)
    {
     ...
     * {@inheritDoc}
     */
    public function removeIpStrategy(\BB\DurianBundle\Entity\MerchantWithdrawIpStrategy $strategy)
    {
