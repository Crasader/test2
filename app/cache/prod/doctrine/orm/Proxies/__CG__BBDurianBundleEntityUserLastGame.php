 ...
 */
class UserLastGame extends \BB\DurianBundle\Entity\UserLastGame implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\UserLastGame' . "\0" . 'user', '' . "\0" . 'BB\\DurianBundle\\Entity\\UserLastGame' . "\0" . 'enable', '' . "\0" . 'BB\\DurianBundle\\Entity\\UserLastGame' . "\0" . 'lastGameCode', '' . "\0" . 'BB\\DurianBundle\\Entity\\UserLastGame' . "\0" . 'modifiedAt', '' . "\0" . 'BB\\DurianBundle\\Entity\\UserLastGame' . "\0" . 'version');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserLastGame $proxy) {
    ...
    public function getLastGameCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastGameCode', array());

        return parent::getLastGameCode();
    }
    ...
    public function setLastGameCode($code)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLastGameCode', array($code));

        return parent::setLastGameCode($code);
    }
