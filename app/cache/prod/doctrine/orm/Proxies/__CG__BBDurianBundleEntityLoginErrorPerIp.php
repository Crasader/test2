 ...
 */
class LoginErrorPerIp extends \BB\DurianBundle\Entity\LoginErrorPerIp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginErrorPerIp' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginErrorPerIp' . "\0" . 'ip', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginErrorPerIp' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginErrorPerIp' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginErrorPerIp' . "\0" . 'count');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LoginErrorPerIp $proxy) {
