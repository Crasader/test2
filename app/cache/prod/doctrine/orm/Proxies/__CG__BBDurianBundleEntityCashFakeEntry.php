 ...
 */
class CashFakeEntry extends \BB\DurianBundle\Entity\CashFakeEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'cashFakeId', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashFakeEntry' . "\0" . 'cashFakeVersion', 'userId', 'currency', 'balance', 'refId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CashFakeEntry $proxy) {
    ...
    public function getCashFakeVersion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCashFakeVersion', array());

        return parent::getCashFakeVersion();
    }
    ...
    public function setCashFakeVersion($cashFakeVersion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCashFakeVersion', array($cashFakeVersion));

        return parent::setCashFakeVersion($cashFakeVersion);
    }
