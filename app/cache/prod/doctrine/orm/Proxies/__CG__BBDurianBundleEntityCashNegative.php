 ...
 */
class CashNegative extends \BB\DurianBundle\Entity\CashNegative implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'userId', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'currency', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'cashId', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'balance', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'negative', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'version', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'entryId', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'opcode', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'amount', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'entryBalance', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'refId', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashNegative' . "\0" . 'memo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CashNegative $proxy) {
    ...
    public function setCashId($cashId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCashId', array($cashId));

        return parent::setCashId($cashId);
    }
