 ...
 */
class CashEntry extends \BB\DurianBundle\Entity\CashEntry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'cashId', '' . "\0" . 'BB\\DurianBundle\\Entity\\CashEntry' . "\0" . 'cashVersion', 'userId', 'currency', 'balance', 'refId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CashEntry $proxy) {
    ...
    public function getCashVersion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCashVersion', array());

        return parent::getCashVersion();
    }
    ...
    public function setCashVersion($cashVersion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCashVersion', array($cashVersion));

        return parent::setCashVersion($cashVersion);
    }
