 ...
 */
class Oauth extends \BB\DurianBundle\Entity\Oauth implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\Oauth' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\Oauth' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\Oauth' . "\0" . 'vendor', '' . "\0" . 'BB\\DurianBundle\\Entity\\Oauth' . "\0" . 'appId', '' . "\0" . 'BB\\DurianBundle\\Entity\\Oauth' . "\0" . 'appKey', '' . "\0" . 'BB\\DurianBundle\\Entity\\Oauth' . "\0" . 'redirectUrl');
        }
