 ...
 */
class StatDomainCashOpcodeHK extends \BB\DurianBundle\Entity\StatDomainCashOpcodeHK implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'userId', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'currency', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'opcode', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'amount', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainCashOpcodeHK' . "\0" . 'count');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatDomainCashOpcodeHK $proxy) {
    ...
    public function setUserId($useId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserId', array($useId));

        return parent::setUserId($useId);
    }
