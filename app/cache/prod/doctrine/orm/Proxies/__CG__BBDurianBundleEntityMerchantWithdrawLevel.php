 ...
 */
class MerchantWithdrawLevel extends \BB\DurianBundle\Entity\MerchantWithdrawLevel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantWithdrawLevel' . "\0" . 'merchantWithdrawId', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantWithdrawLevel' . "\0" . 'levelId', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantWithdrawLevel' . "\0" . 'orderId', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantWithdrawLevel' . "\0" . 'version');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MerchantWithdrawLevel $proxy) {
    ...
    public function getMerchantWithdrawId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getMerchantWithdrawId();
        }
