 ...
 */
class Test extends \BB\DurianBundle\Entity\Test implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\Test' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\Test' . "\0" . 'memo');
        }
