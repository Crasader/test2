 ...
 */
class GlobalIp extends \BB\DurianBundle\Entity\GlobalIp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\GlobalIp' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\GlobalIp' . "\0" . 'ip', '' . "\0" . 'BB\\DurianBundle\\Entity\\GlobalIp' . "\0" . 'memo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GlobalIp $proxy) {
