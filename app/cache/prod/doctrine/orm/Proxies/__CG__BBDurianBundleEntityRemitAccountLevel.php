 ...
 */
class RemitAccountLevel extends \BB\DurianBundle\Entity\RemitAccountLevel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitAccountLevel' . "\0" . 'remitAccountId', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitAccountLevel' . "\0" . 'levelId', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitAccountLevel' . "\0" . 'orderId', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitAccountLevel' . "\0" . 'version');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RemitAccountLevel $proxy) {
    ...
    public function getRemitAccountId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getRemitAccountId();
        }
