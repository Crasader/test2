 ...
 */
class AutoRemit extends \BB\DurianBundle\Entity\AutoRemit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\AutoRemit' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\AutoRemit' . "\0" . 'removed', '' . "\0" . 'BB\\DurianBundle\\Entity\\AutoRemit' . "\0" . 'label', '' . "\0" . 'BB\\DurianBundle\\Entity\\AutoRemit' . "\0" . 'name', '' . "\0" . 'BB\\DurianBundle\\Entity\\AutoRemit' . "\0" . 'version', '' . "\0" . 'BB\\DurianBundle\\Entity\\AutoRemit' . "\0" . 'bankInfo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AutoRemit $proxy) {
