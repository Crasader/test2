 ...
 */
class WithdrawError extends \BB\DurianBundle\Entity\WithdrawError implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\WithdrawError' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\WithdrawError' . "\0" . 'entryId', '' . "\0" . 'BB\\DurianBundle\\Entity\\WithdrawError' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\WithdrawError' . "\0" . 'errorMessage', '' . "\0" . 'BB\\DurianBundle\\Entity\\WithdrawError' . "\0" . 'errorCode', '' . "\0" . 'BB\\DurianBundle\\Entity\\WithdrawError' . "\0" . 'operator');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WithdrawError $proxy) {
    ...
    public function setAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAt', array());
