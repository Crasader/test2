 ...
 */
class LevelUrl extends \BB\DurianBundle\Entity\LevelUrl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\LevelUrl' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\LevelUrl' . "\0" . 'level', '' . "\0" . 'BB\\DurianBundle\\Entity\\LevelUrl' . "\0" . 'url', '' . "\0" . 'BB\\DurianBundle\\Entity\\LevelUrl' . "\0" . 'enable');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LevelUrl $proxy) {
