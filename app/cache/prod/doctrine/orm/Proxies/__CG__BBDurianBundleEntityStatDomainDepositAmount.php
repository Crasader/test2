 ...
 */
class StatDomainDepositAmount extends \BB\DurianBundle\Entity\StatDomainDepositAmount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainDepositAmount' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainDepositAmount' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainDepositAmount' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatDomainDepositAmount' . "\0" . 'amount');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatDomainDepositAmount $proxy) {
