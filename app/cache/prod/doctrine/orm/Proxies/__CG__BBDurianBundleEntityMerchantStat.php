 ...
 */
class MerchantStat extends \BB\DurianBundle\Entity\MerchantStat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantStat' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantStat' . "\0" . 'merchant', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantStat' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantStat' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantStat' . "\0" . 'count', '' . "\0" . 'BB\\DurianBundle\\Entity\\MerchantStat' . "\0" . 'total');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MerchantStat $proxy) {
