 ...
 */
class OutsideTrans extends \BB\DurianBundle\Entity\OutsideTrans implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'userId', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'currency', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'opcode', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'amount', 'refId', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'createdAt', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'checked', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'checkedAt', '' . "\0" . 'BB\\DurianBundle\\Entity\\OutsideTrans' . "\0" . 'memo', 'group');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OutsideTrans $proxy) {
