 ...
 */
class StatCashOpcode extends \BB\DurianBundle\Entity\StatCashOpcode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'at', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'userId', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'currency', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'parentId', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'opcode', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'amount', '' . "\0" . 'BB\\DurianBundle\\Entity\\StatCashOpcode' . "\0" . 'count');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatCashOpcode $proxy) {
