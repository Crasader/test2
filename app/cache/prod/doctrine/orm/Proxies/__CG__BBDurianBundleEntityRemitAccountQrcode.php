 ...
 */
class RemitAccountQrcode extends \BB\DurianBundle\Entity\RemitAccountQrcode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitAccountQrcode' . "\0" . 'remitAccountId', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitAccountQrcode' . "\0" . 'qrcode');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RemitAccountQrcode $proxy) {
