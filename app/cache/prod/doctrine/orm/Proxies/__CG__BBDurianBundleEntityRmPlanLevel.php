 ...
 */
class RmPlanLevel extends \BB\DurianBundle\Entity\RmPlanLevel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\RmPlanLevel' . "\0" . 'id', '' . "\0" . 'BB\\DurianBundle\\Entity\\RmPlanLevel' . "\0" . 'planId', '' . "\0" . 'BB\\DurianBundle\\Entity\\RmPlanLevel' . "\0" . 'levelId', '' . "\0" . 'BB\\DurianBundle\\Entity\\RmPlanLevel' . "\0" . 'levelAlias');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RmPlanLevel $proxy) {
