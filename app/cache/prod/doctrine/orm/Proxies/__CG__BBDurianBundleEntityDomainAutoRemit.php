 ...
 */
class DomainAutoRemit extends \BB\DurianBundle\Entity\DomainAutoRemit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\DomainAutoRemit' . "\0" . 'domain', '' . "\0" . 'BB\\DurianBundle\\Entity\\DomainAutoRemit' . "\0" . 'autoRemitId', '' . "\0" . 'BB\\DurianBundle\\Entity\\DomainAutoRemit' . "\0" . 'enable', '' . "\0" . 'BB\\DurianBundle\\Entity\\DomainAutoRemit' . "\0" . 'apiKey');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DomainAutoRemit $proxy) {
    ...
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getAutoRemitId();
        }
