 ...
 */
class LoginLogMobile extends \BB\DurianBundle\Entity\LoginLogMobile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginLogMobile' . "\0" . 'loginLogId', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginLogMobile' . "\0" . 'name', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginLogMobile' . "\0" . 'brand', '' . "\0" . 'BB\\DurianBundle\\Entity\\LoginLogMobile' . "\0" . 'model');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LoginLogMobile $proxy) {
