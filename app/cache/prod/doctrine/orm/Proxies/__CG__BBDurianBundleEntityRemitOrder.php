 ...
 */
class RemitOrder extends \BB\DurianBundle\Entity\RemitOrder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitOrder' . "\0" . 'orderNumber', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitOrder' . "\0" . 'used', '' . "\0" . 'BB\\DurianBundle\\Entity\\RemitOrder' . "\0" . 'version');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RemitOrder $proxy) {
